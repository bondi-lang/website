...
{{%alert info%}}You can, also, **embed presentation in a page** as a small box, using the [revealjs]({{% relref "meta/shortcodes/revealjs.md"%}}) shortcode in your md file.{{%/alert%}}
